---
title: "Session 1: Introduction to the NIME Organisation"
...
- Participants identify role(s) that fit their interests, skills, and career stage
- Facilitators learn what backgrounds and skills participants could bring to NIME
...
- Participants place themselves against the roles map (now vs future)
- Prompt: what would you bring? what's stopping you?
- Format: individual reflection, then table discussion

### Activity 2: Share-back

- Each table surfaces one role and one barrier
- Facilitators respond: demystify the role, name the support that exists

## Facilitator notes

- Have a board/committee member ready to speak to each role
